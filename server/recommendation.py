...
def load_matrices(category):
    ratings_matrix = load_npz(f'/home/aladeen/CapstoneProject/csr_matrix/{category}_ratings_matrix.npz')
    item_similarity = load_npz(f'/home/aladeen/CapstoneProject/csr_matrix/{category}_item_similarity.npz')

    with open(f'/home/aladeen/CapstoneProject/csr_matrix/{category}_user_to_index.json', 'r') as user_file:
        user_to_index = json.load(user_file)

    with open(f'/home/aladeen/CapstoneProject/csr_matrix/{category}_item_to_index.json', 'r') as item_file:
